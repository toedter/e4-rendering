...
public class MenuThemeProcessor extends AbstractThemeProcessor {
	...
	private static final String BUNDLE_ID = "platform:/plugin/com.toedter.e4.demo.contacts.swing"; //$NON-NLS-1$
	private final static String PROCESSOR_ID = "com.toedter.e4.demo.contacts.swing.processors.theme.menu";
